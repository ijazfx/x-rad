 ...
 * Schema.
 * $Id: AppConfig.java,v 1.1.1.1 2006/08/25 18:58:07 Ali Mazhar Exp $
 */
...
public class AppConfig implements java.io.Serializable {
     ...
     * @return Interaction
     */
    public com.xradsolutions.xrad.xmlbo.Interaction[] getInteraction()
    {
        int size = _interactionList.size();
        com.xradsolutions.xrad.xmlbo.Interaction[] mArray = new com.xradsolutions.xrad.xmlbo.Interaction[size];
     ...
     * @return Process
     */
    public com.xradsolutions.xrad.xmlbo.Process[] getProcess()
    {
        int size = _processList.size();
        com.xradsolutions.xrad.xmlbo.Process[] mArray = new com.xradsolutions.xrad.xmlbo.Process[size];
        for (int index = 0; index < size; index++) {
     ...
     * @return View
     */
    public com.xradsolutions.xrad.xmlbo.View[] getView()
    {
        int size = _viewList.size();
        com.xradsolutions.xrad.xmlbo.View[] mArray = new com.xradsolutions.xrad.xmlbo.View[size];
        for (int index = 0; index < size; index++) {
     ...
     */
    public void setInteraction(com.xradsolutions.xrad.xmlbo.Interaction[] interactionArray)
    {
        //-- copy array
        _interactionList.removeAllElements();
     ...
     * @param processArray
     */
    public void setProcess(com.xradsolutions.xrad.xmlbo.Process[] processArray)
    {
        //-- copy array
        _processList.removeAllElements();
     ...
     * @param viewArray
     */
    public void setView(com.xradsolutions.xrad.xmlbo.View[] viewArray)
    {
        //-- copy array
        _viewList.removeAllElements();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.xradsolutions.xrad.xmlbo.AppConfig) Unmarshaller.unmarshal(com.xradsolutions.xrad.xmlbo.AppConfig.class, reader);
