...
public class XRadStrutsGenerator
    extends AbstractCodeGenerator {

  public XRadStrutsGenerator(JFrame parent, java.util.Properties props) {
    super(parent, props);
  ...
  public void generateCode() {
    ...
    generateCode(super.SRC_PATH, "/org/apache/xrad/cg/struts-xrad-code.xsl");
    // generate jsp files
    generateCode(super.WEB_PATH, "/org/apache/xrad/cg/struts-jsp.xsl");
    // generate struts-config.xml
    generateCode(super.WEB_PATH,
                 "/org/apache/xrad/cg/struts-config-xrad.xsl");
    // copy xrd file to web-inf folder...
    copyResource(super.WEB_PATH + "/pages", "xrad-style.css",
                 "/org/apache/xrad/cg/xrad-style.css");
    JOptionPane
        .showMessageDialog(parent,
                           "The X-RAD Enabled Struts Code has been generated successfully!!");
  }

  public void generateCode(String path, String xslFile) {
    TransformerFactory factory = new TransformerFactoryImpl();
    InputStream xslStream = XRadStrutsGenerator.class
